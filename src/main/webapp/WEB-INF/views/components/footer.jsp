...
<footer class="footer-sora">
    <div class="container">
        <div class="row g-4 pb-4 border-bottom border-secondary border-opacity-25">
            <div class="col-lg-4 col-md-6">
                <div class="d-flex align-items-center gap-2 mb-3">
                    <i class="bi bi-buildings-fill text-info fs-3"></i>
                    <span class="fs-4 fw-bold text-white">INMOBILIARIA SORA</span>
                </div>
                <p class="small text-secondary mb-4">
                    Plataforma tecnológica líder para la compra, venta y arrendamiento de bienes raíces premium en Colombia. Conectamos sueños con su espacio ideal.
                </p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled small text-secondary d-flex flex-column gap-2">
                    <li><i class="bi bi-geo-alt me-2 text-info"></i> Carrera 15 #27-30, Bucaramanga</li>
                    <li><i class="bi bi-telephone me-2 text-info"></i> +57 (607) 123-4567</li>
                    <li><i class="bi bi-envelope me-2 text-info"></i> contacto@sora.com</li>
                    <li><i class="bi bi-clock me-2 text-info"></i> Lun - Sáb: 8:00 AM - 6:00 PM</li>
                </ul>
            </div>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center pt-4 small text-secondary">
            <div>
                &copy; 2026 Inmobiliaria Sora SAS. Proyecto Universitario Java EE + Tomcat 10 + PostgreSQL.
            </div>
